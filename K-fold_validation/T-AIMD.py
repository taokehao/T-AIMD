...
# 导入训练数据
data = np.loadtxt("../data/feature_encoder_600+material.csv", delimiter=',')
...
for train, test in kf.split(data):
    ...
    model = cat.CatBoostRegressor(iterations=1200, learning_rate=0.020000000000000004, max_depth=8, subsample=0.7)
    ...
    csvFile = open("./cal-pre-data/T-AIMD"+str(index)+".csv", 'a', newline='', encoding='utf-8')
