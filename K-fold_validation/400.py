...
# 导入训练数据
data = np.loadtxt("../data/feature_encoder_400+material.csv", delimiter=',')
...
for train, test in kf.split(data):
    ...
    model = cat.CatBoostRegressor(iterations=1500, learning_rate=0.01, max_depth=8, subsample=0.7)
    ...
    csvFile = open("./cal-pre-data/400+material-"+str(index)+".csv", 'a', newline='', encoding='utf-8')
